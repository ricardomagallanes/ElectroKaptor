...
2. **LEDs Indicadores de Estado (Lado inferior PCB):**
   - **D6 (Verde superior):** Resistencia limitadora `R19`. Conectado al bus GPIO del STM32 (Rango `PA4..PA7` o `PB0..PB2`).
   - **D5 (Rojo):** Resistencia limitadora `R18`.
   - **D3 (Rojo):** Resistencia limitadora `R16`.
   - **D4 (Rojo inferior):** Resistencia limitadora `R17`.
   *(Las 4 pistas finas bajan desde la parte inferior/derecha del encapsulado LQFP48 hacia las resistencias R19, R18, R16 y R17).*
