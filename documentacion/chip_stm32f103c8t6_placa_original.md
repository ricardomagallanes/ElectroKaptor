...
2. **LEDs Indicadores de Estado (Lado inferior):**
   - **D6 (Verde superior):** Resistencia limitadora `R19` (Alimentación / Estado OK).
   - **D5 (Rojo):** Resistencia limitadora `R18` (Transmisión LoRaWAN).
